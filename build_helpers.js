      ...
      <div class="footer-top-grid">
        ...
        <div class="footer-col footer-col-connect">
          ...
          <div class="footer-connect-list">
            ...
            <!-- Facebook -->
            <a href="https://www.facebook.com/glowisticpkofficial" target="_blank" rel="noopener noreferrer" class="footer-connect-row" aria-label="Facebook Glowistic Official">
              <span class="connect-icon-badge" aria-hidden="true">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
